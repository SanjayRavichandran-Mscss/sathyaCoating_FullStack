      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Manage and assign personnel to oversee your project sites with ease
          </p>
        </div>
...
//     // Update designations if the designation_id is new
//     setDesignations((prev) => {
//       if (!prev.some((d) => d.id === designation_id)) {
//         return [...prev, { id: designation_id, designation }];
//       }
...
//     // Update the row with the new employee's emp_id
...
//   // Handle opening the Add Employee modal for a specific row
//   const handleOpenAddEmployeeModal = (index) => {
...
//                           <button
//                             type="button"
//                             onClick={() => handleOpenAddEmployeeModal(index)}
//                             className="p-1.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
//                             title="Add new employee"
//                           >
//                             <PlusCircle className="h-4 w-4" />
