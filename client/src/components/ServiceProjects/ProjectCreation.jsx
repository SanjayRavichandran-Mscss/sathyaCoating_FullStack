...
//     try {
//       const [companyResponse, siteInchargesResponse, projectsResponse] = await Promise.all([
...
//       if (onProjectCreated) {
//         onProjectCreated(companyId); // Trigger redirect to ViewProjects
//       }
//     } catch (error) {
//       console.error("Error creating project:", error);
//       setError(error.response?.data?.message || "Failed to create project and site. Please try again.");
//       Swal.fire({
//         icon: "error",
//         title: "Error",
//         text: error.response?.data?.message || "Failed to create project and site. Please try again.",
//         confirmButtonColor: "#2563eb",
//       });
//     } finally {
//       setLoading(false);
